            ...
            <div class="col-md-9" >
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('Pantalla/create') }}" class="btn btn-success btn-smn  float-left mr-sm-2" title="Crear tamaño de Pantalla">
                            Agregar tamaño de Pantalla</a>
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <div class="form-inline my-2 my-lg-0 float-right">
                                                <div class="input-group">
                                                    <a href="{{ url('/Pantalla/' . $item->id) }}" title="Vista del tamaño de la Pantalla" > <button class="btn btn-info btn-smn form-control mr-sm-3" > <i aria-hidden="true"></i>  Vista </button> </a>

                                                    <a href="{{ url('/Pantalla/' . $item->id . '/edit') }}" title="Editar tamaño de la Pantalla"> <button class="btn btn-warning btn-smn mr-sm-3"> <i aria-hidden="true"></i>  Editar </button></a>


                                                    <form method="POST" action="{{ url('/Pantalla' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                        {{ method_field('DELETE') }}
                                                        {{ csrf_field() }}
                                                        <a> <button type="submit" class="btn btn-danger btm-sm   " title="Eliminar Pantalla" onclick="return confirm('¿Desea_Borrar_el_Dato?');"> <i  aria-hidden="true"></i>Borrar</button> </a>

                        ...
                        @endif
                            ...
                            <div class="row">
                                <div class="col mt-1 col-md-auto">
                                    ...
                                    <br/>
                                    <select name="productos_id" id="productos_id" class="form-control col-md-auto" data-Live-search="true" value="{{ isset($productos->productos_id)? $productos->productos_id:''}}">
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------------------->
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="guardar">
                                <div class="form-group">
                                    <input type="submit" class="btn btn-success" value="{{ $Modo == 'crear' ? 'Guardar' : 'Editar' }}">
    ...
    <script type="text/javascript">
        ...
        function agregar(){
            ...
            modelos_id = $('#modelos_id option:selected').text();
            ...
            if(productos_id != "" && Cantidad != "" && Cantidad > 0 && Precio != "" && Descuento != "" )
            {
                ...
                if(Stock >= Cantidad)
                {
                    ...
                    var fila = '<tr class="selected" id="fila'+cont+'"><td><button class"btn btn-danger" type"button" onclick="eliminar('+cont+');">X</button></td><td><input type="hidden" name="productos_id[]" value="'+productos_id+'">'+/*   */modelos_id+'</td><td><input type="number" name="Cantidad[]" value="'+Cantidad+'"></td><td><input type="number" name="Precio[]" value="'+Precio+'" readonly></td><td><input type="number" name="Descuento[]" value="'+Descuento+'"></td><td>'+Subtotal[cont]+'</td></tr>';
